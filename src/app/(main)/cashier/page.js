...
export default function Page() {
	...
	return (
		<div className="flex  items-center justify-center bg-white px-4 py-6 sm:px-6 lg:px-8">
			{isLoading ? (
				...
				<div className="w-full max-w-md space-y-8">
					<div>
						<h2 className="mt-6 text-center text-3xl font-bold tracking-tight text-gray-900">Bienvenido, {user?.firstName} {user?.lastName}</h2>
						<p className="mt-2 text-center text-sm text-gray-600">Seleccione una opción</p>
					</div>
					<div className="grid grid-cols-2 gap-4">
						<Link
							href="/employee/checklist"
							className="flex flex-col items-center justify-center rounded-lg bg-white p-6 shadow-lg transition-transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-black focus:ring-offset-2 border"
							prefetch={false}
						>
