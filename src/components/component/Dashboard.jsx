            ...
            <Table>
              ...
              <TableBody>
                <TableRow>
                  ...
                  <TableCell className="hidden md:table-cell">June 15, 2023</TableCell>
                ...
                <TableRow>
                  ...
                  <TableCell className="hidden md:table-cell">July 1, 2023</TableCell>
                ...
                <TableRow>
                  ...
                  <TableCell className="hidden md:table-cell">May 30, 2023</TableCell>
                  <TableCell className="hidden md:table-cell">Overdue</TableCell>
                  <TableCell className="text-right">
                    <DropdownMenu>
                      <DropdownMenuTrigger asChild>
                        <Button size="icon" variant="ghost">
                ...
                <TableRow>
                  ...
                  <TableCell className="hidden md:table-cell">April 15, 2023</TableCell>
                  <TableCell className="hidden md:table-cell">Completed</TableCell>
                  <TableCell className="text-right">
                    <DropdownMenu>
                      <DropdownMenuTrigger asChild>
                ...
                <TableRow>
                  ...
                  <TableCell className="hidden md:table-cell">March 1, 2023</TableCell>
                  <TableCell className="hidden md:table-cell">Completed</TableCell>
                  <TableCell className="text-right">
                    <DropdownMenu>
                      <DropdownMenuTrigger asChild>
                ...
                <TableRow>
                  ...
                  <TableCell className="hidden md:table-cell">January 10, 2023</TableCell>
                  <TableCell className="hidden md:table-cell">Completed</TableCell>
                  <TableCell className="text-right">
                    <DropdownMenu>
                      <DropdownMenuTrigger asChild>
                ...
                <TableRow>
                  ...
                  <TableCell className="hidden md:table-cell">December 1, 2022</TableCell>
                </TableRow>
              </TableBody>
            </Table>
          </div>
