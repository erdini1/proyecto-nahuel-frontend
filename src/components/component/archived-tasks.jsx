...
//             displayDate: format(new Date(task.createdAt), 'dd/MM'),
//         }));
...
//                                             <div>
//                                                 <h3 className="font-semibold mb-2">Tareas Completadas</h3>
//                                                 <ul className="grid gap-2 mb-4">
//                                                     {groupedTasksByDate[date].completadas.map(task => (
...
//                                                     ))}
//                                                 </ul>
//                                                 <h3 className="font-semibold mb-2">Tareas Incompletas</h3>
//                                                 <ul className="grid gap-2">
//                                                     {groupedTasksByDate[date].incompletas.map(task => (
//                                                         <li key={task.id} className="flex items-center justify-between">
//                                                             <div className="flex items-center gap-2">
