					...
					<ToggleGroup type="single" className="justify-center grid grid-cols-3 gap-4">
						{cashBoxes.map((cashBox) => (
							<ToggleGroupItem
								...
								id="cashBox"
								variant="outline"
								className={`w-full ${disabledButtons && cashBoxId !== cashBox.id ? 'opacity-70 ' : 'shadow'}`}
...
// 	const handleCashBoxChange = (number) => {
// 		setCashBoxId(number);
...
// 							<ToggleGroupItem
// 								key={cashBox.id}
// 								value={cashBoxId === cashBox.id}
// 								id="cashBox"
// 								variant="outline"
// 								className={`w-1/4 ${disabledButtons && cashBoxId !== cashBox.id ? 'opacity-50 ' : 'shadow'}`}
// 								onClick={() => handleCashBoxChange(cashBox.id)}
// 								disabled={disabledButtons && cashBoxId !== cashBox.id}
// 								pressed={cashBoxId === cashBox.id}
// 							>
// 								{cashBox.description}
// 							</ToggleGroupItem>
// 						))}
...
// 					className="w-full"
// 					type="submit"
// 					disabled={cashBoxId === '' || initialAmount === ''}
// 				>Guardar Datos Iniciales</Button>
// 			</form>
// 		</div>
// 	);
