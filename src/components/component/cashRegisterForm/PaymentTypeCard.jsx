	...
	return (
		<div className='flex flex-col w-full'>
			<Table className="w-full bg-slate-900">
				<TableHeader>
					<TableRow>
						<TableHead className="uppercase flex flex-col p-2 text-white">Tarjetas
							<span className="text-xs font-normal text-gray-400 uppercase"> (Clover / QR - TDF - La red)</span>
						</TableHead>
					</TableRow>
				</TableHeader>
				<TableBody>
